...
//rtcl-lost-password
 ...
 function sendotp() {
    try {
        ...
        $otp_email=$_SESSION['email_to_check'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get email from form submission and sanitize it
    $_SESSION['email_to_check'] = mysqli_real_escape_string($conn, $_POST['user_login']);

    // Debug: Output the email for verification
   // echo "<script>console.log('Email to check: " . $_SESSION['email_to_check'] . "');</script>";
 $email_to_check = mysqli_real_escape_string($conn, $_POST['user_login']);
    // SQL query to check if email exists in the 'tbl_users' table
    $sql = "SELECT id FROM tbl_users WHERE email = '$email_to_check'";
    $result = mysqli_query($conn, $sql);

    // Check for query errors
    if (!$result) {
        // Debug: Output SQL error for troubleshooting
        echo "<script>console.log('SQL Error: " . mysqli_error($conn) . "');</script>";
        echo "<script>
            window.onload = function() {
                Swal.fire({
                    icon: 'error',
                    title: 'Database Error',
                    text: 'There was an error executing the query.',
        ...
        // Output JavaScript alert based on the result
            ...
            echo "<script>
                window.onload = function() {
                    Swal.fire({
                        ...
                        text: 'An OTP has been sent to your email: $email_to_check.',
...
<!-- Mirrored from www.radiustheme.com/demo/wordpress/themes/homlisti/my-account/lost-pass/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jul 2024 13:33:50 GMT -->
...
<script>
var wpo_server_info_css = {"user_agent":"Mozilla\/5.0 (Linux; Android 10; K) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/127.0.0.0 Mobile Safari\/537.36"}
...
<link rel='stylesheet' id='wpo_min-header-0-css' href='../../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-header-f7533a43.min.css' type='text/css' media='all' />
...
<script>
var wpo_server_info_js = {"user_agent":"Mozilla\/5.0 (Linux; Android 10; K) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/127.0.0.0 Mobile Safari\/537.36"}
    loadAsync('../../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-header-422682a3.min.js', null);
</script>
<link rel="https://api.w.org/" href="../../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../../wp-json/wp/v2/pages/95.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
<meta name="generator" content="WordPress 6.6.1" />
<link rel="canonical" href="../index.php" />
<link rel='shortlink' href='../../index5eda.html?p=95' />
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed56d6.json?url=https%3A%2F%2Fwww.radiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fhomlisti%2Fmy-account%2F" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embedaac4?url=https%3A%2F%2Fwww.radiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fhomlisti%2Fmy-account%2F&amp;format=xml" />
...
<body class="page-template-default page page-id-95 rtcl-account rtcl-page rtcl-no-js HomListi-version-1.10.4 theme-homlisti header-style-4 header-width-box-width sticky-header no-trheader homlisti-core-installed product-grid-view page-my-account elementor-default elementor-kit-2673">
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4735"><a href="../../contact/index.php">Contact</a></li>
		...
		<div id="content" class="site-content">
                ...
                <div class="container">
					<nav class="rtcl-breadcrumb"><a href="https://www.radiustheme.com/demo/wordpress/themes/homlisti">Home</a>&nbsp;<i class="fas fa-angle-right"></i>&nbsp;<a href="../index.php">My Account</a>&nbsp;<i class="fas fa-angle-right"></i>&nbsp;<span>Lost password</span></nav>                </div>
...
<form id="rtcl-lost-password-form" class="form-horizontal" method="post">
	...
	<p>Lost your password? Please enter your email address. You will receive email to create a new password via email.</p>	<div class="rtcl-form-group">
	...
	<div class="rtcl-form-submit-wrap">
		<input type="submit" name="rtcl-lost-password" class="btn" value="Reset Password"/>
	</div>
	<input type="hidden" id="rtcl-lost-password-nonce" name="rtcl-lost-password-nonce" value="586a636874" /><input type="hidden" name="_wp_http_referer" value="/demo/wordpress/themes/homlisti/my-account/lost-pass/" />
</form>
</div>
                                    </div>
                                </div>
...
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1721913920" /><input type="hidden" name="_mc4wp_form_id" value="7934" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin --></div><div id="text-2" class="footer-box widget_text">			<div class="textwidget"><p>We never span you!</p>
</div>
...
<script>
var wpo_server_info_js = {"user_agent":"Mozilla\/5.0 (Linux; Android 10; K) AppleWebKit\/537.36 (KHTML, like Gecko) Chrome\/127.0.0.0 Mobile Safari\/537.36"}
    loadAsync('../../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-footer-1d009b34.min.js', null);
</script>
...
<!-- Cached by WP-Optimize - https://getwpo.com - Last modified: July 25, 2024 1:25 pm (UTC:0) -->
