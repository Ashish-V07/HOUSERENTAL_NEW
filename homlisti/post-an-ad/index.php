...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $stored_password)) {
            ...
            header("Location: add_property_new.php"); 
            exit();
        } else {
...
<!-- Mirrored from www.radiustheme.com/demo/wordpress/themes/homlisti/post-an-ad/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jul 2024 13:27:53 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="profile" href="../index.php://gmpg.org/xfn/11" />
    <script>function loadAsync(e,t){var a,n=!1;a=document.createElement("script"),a.type="text/javascript",a.src=e,a.onreadystatechange=function(){n||this.readyState&&"complete"!=this.readyState||(n=!0,"function"==typeof t&&t())},a.onload=a.onreadystatechange,document.getElementsByTagName("head")[0].appendChild(a)}</script>
<title>Post an Ad &#8211; HomListi</title>
...
<style class="optimize_css_2" type="text/css" media="all">/*! Generated by Font Squirrel (../index.php://www.fontsquirrel.com) on June 9, 2021 */
 @font-face{font-family:'quentinregular';src:url(../wp-content/themes/homlisti/assets/fonts/quentin-webfont.woff2) format('woff2'),url(../index.php../index.phpwp-content/themes/homlisti/assets/css/../fonts/quentin-webfont.woff) format('woff');font-weight:400;font-style:normal}</style>
...
<link rel='stylesheet' id='wpo_min-header-0-css' href='../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-header-f99e43c2.min.css' type='text/css' media='all' />
<script type="text/javascript" src="../wp-includes/js/jquery/jquery.min.js" id="jquery-core-js"></script>
<script type="text/javascript" id="wpo_min-header-0-js-extra">
/* <![CDATA[ */
var userSettings = {"url":"\/demo\/wordpress\/themes\/homlisti\/","uid":"0","time":"1721913717","secure":"1"};
...
var rtcl_compare = {"ajaxurl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php","server_error":"Server Error!!"};
var rtcl_quick_view = {"ajaxurl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php","server_error":"Server Error!!","selector":".rtcl-quick-view","max_width":"1000","wrap_class":"rtcl-qvw no-heading"};
/* ]]> */
</script>
<script>
var wpo_server_info_js = {"user_agent":"Mozilla\/4.5 (compatible; HTTrack 3.0x; Windows 98)"}
    loadAsync('../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-header-2cf09f33.min.js', null);
</script>
<link rel="../index.php://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/2363.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<meta name="generator" content="WordPress 6.6.1" />
<link rel="canonical" href="index.php" />
<link rel='shortlink' href='../indexc200.html?p=2363' />
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="../wp-json/oembed/1.0/embedef6e.json?url=../index.php%3A%2F%2Fwww.radiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fhomlisti%2Fpost-an-ad%2F" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed00d9?url=../index.php%3A%2F%2Fwww.radiustheme.com%2Fdemo%2Fwordpress%2Fthemes%2Fhomlisti%2Fpost-an-ad%2F&amp;format=xml" />
...
<meta name="msapplication-TileImage" content="../index.php../index.phpwp-content/uploads/2021/09/cropped-favicon-homlisti-270x270.png" />
		<style type="text/css" id="wp-custom-css">
			.rt-el-testimonial-carousel .slick-list {
    overflow: hidden;
}		</style>
		</head>
<body class="page-template-default page page-id-2363 rtcl-form-page rtcl-page rtcl-no-js HomListi-version-1.10.4 theme-homlisti header-style-4 header-width-box-width sticky-header no-trheader homlisti-core-installed product-grid-view page-post-an-ad elementor-default elementor-kit-2673">
...
<!--			                <li class="favourite has-count-number button" style="">
                    ...
                    <a href="index.php" class="item-btn rt-animation-btn">
						<span>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4735"><a href="../contact/index.php">Contact</a></li>
		...
		<div id="content" class="site-content">
                ...
                <div class="container">
					<nav class="rtcl-breadcrumb"><a href="../index.php">Home</a>&nbsp;<i class="fas fa-angle-right"></i>&nbsp;<span>Post an Ad</span></nav>                </div>
        ...
        <div class="col-md-12 rtcl-login-form-wrap">
            ...
            <form id="rtcl-login-form" class="form-horizontal" method="post">
                    ...
                    <label for="rtcl-user-login" class="control-label">
						 E-mail                        <strong class="rtcl-required">*</strong>
                    </label>
                ...
                <div class="form-group">
                    <p class="rtcl-forgot-password">
                        <a href="../my-account/lost-pass/index.php">Forgot your password?</a>
                    </p>
                </div>
				<input type="hidden" id="rtcl-login-nonce" name="rtcl-login-nonce" value="cf52537014" /><input type="hidden" name="_wp_http_referer" value="/demo/wordpress/themes/homlisti/post-an-ad/" /><input type="hidden" name="redirect_to" value="index.php" />            </form>
        </div>
		    </div>
</div>
            </div>
...
<!--				<div id="sticky_sidebar" class="col-lg-4 col-sm-12 sidebar-break-lg">
		...
		<form method="get" class="custom-search-form" action="../index.php../index.php">
			...
			<ul>
					<li class="cat-item cat-item-8"><a href="../category/building/index.php">Building<span>(3)</span></a>
</li>
	<li class="cat-item cat-item-54"><a href="../category/education/index.php">Education<span>(1)</span></a>
</li>
	<li class="cat-item cat-item-55"><a href="../category/entertainment/index.php">Entertainment<span>(4)</span></a>
</li>
	<li class="cat-item cat-item-7"><a href="../category/real-estate/index.php">Real-estate<span>(4)</span></a>
</li>
			</ul>

			</div><div id="archives-3" class="widget widget_archive"><h3 class="widget-heading">Archives</h3>
			<ul>
					<li><a href='../2021/08/index.php'>August 2021<span>(9)</span></a></li>
	<li><a href='../2020/11/index.php'>November 2020<span>(1)</span></a></li>
			</ul>
...
<div class="rtcl rtcl-widget-listings">
    <div class="rtcl-grid-view columns-1 tab-columns-1 mobile-columns-1"
         data-options="">
				...
				<div class='listing-thumb'><a href='../property/triple-story-house-for-rent/index.php' title='Triple Story House for Rent'><img width="400" height="240" src="../wp-content/uploads/classified-listing/2022/03/robert_blue5-1-400x240.jpg" class="rtcl-thumbnail" alt="robert_blue5-1" decoding="async" title="" /> <span class='listing-type-badge'>For Rent</span></a></div><div class="item-content"> <div class="property-type"><a href="../listing-category/studio-home/index.php">Studio Home</a></div> <h3 class="listing-title rtcl-listing-title"><a href="../property/triple-story-house-for-rent/index.php" title="Triple Story House for Rent">Triple Story House for Rent</a></h3> <ul class="listing-meta"><li class="location"><i class="rtcl-icon rtcl-icon-location" aria-hidden="true"></i><a href="../listing-location/new-jersey/index.php">New Jersey</a></li></ul> <div class="listing-price"><div class="rtcl-price price-type-fixed"><div class="rtcl-price-range"><span class="price-from"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>13,500</bdi></span></span> <span class="dash">&ndash;</span> <span class="price-to"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>20,000</bdi></span></span></div><span class="rtcl-price-meta"><span class="rtcl-price-unit-label rtcl-price-unit-year">yr</span></span></div></div></div>
            </div>
				...
				<div class='listing-thumb'><a href='../property/brand-new-shopping-mall-for-buy/index.php' title='Brand New Shopping Mall for buy'><img width="400" height="240" src="../wp-content/uploads/classified-listing/2022/03/robert_blue1-1-400x240.jpg" class="rtcl-thumbnail" alt="robert_blue1-1" decoding="async" title="" /> <span class='listing-type-badge'>For Buy</span></a></div><div class="item-content"> <div class="property-type"><a href="../listing-category/apartments/index.php">Apartments</a></div> <h3 class="listing-title rtcl-listing-title"><a href="../property/brand-new-shopping-mall-for-buy/index.php" title="Brand New Shopping Mall for buy">Brand New Shopping Mall for buy</a></h3> <ul class="listing-meta"><li class="location"><i class="rtcl-icon rtcl-icon-location" aria-hidden="true"></i><a href="../listing-location/new-jersey/index.php">New Jersey</a></li></ul> <div class="listing-price"><div class="rtcl-price price-type-negotiable"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>30,000</bdi></span><span class="rtcl-price-meta"><span class="rtcl-price-unit-label rtcl-price-unit-total">total</span></span></div></div></div>
            </div>
				...
				<div class='listing-thumb'><a href='../property/northwest-office-space/index.php' title='Northwest Office Space'><img width="400" height="240" src="../wp-content/uploads/classified-listing/2022/03/daziy_millar3-1-400x240.jpg" class="rtcl-thumbnail" alt="daziy_millar3-1" decoding="async" title="" /> <span class='listing-type-badge'>For Buy</span></a></div><div class="item-content"> <div class="property-type"><a href="../listing-category/apartments/index.php">Apartments</a></div> <h3 class="listing-title rtcl-listing-title"><a href="../property/northwest-office-space/index.php" title="Northwest Office Space">Northwest Office Space</a></h3> <ul class="listing-meta"><li class="location"><i class="rtcl-icon rtcl-icon-location" aria-hidden="true"></i><a href="../listing-location/new-jersey/index.php">New Jersey</a></li></ul> <div class="listing-price"><div class="rtcl-price price-type-fixed"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>450,000</bdi></span></div></div></div>
            </div>
				...
				<div class='listing-thumb'><a href='../property/diamond-manco-apartment/index.php' title='Diamond Manco Apartment'><img width="400" height="240" src="../wp-content/uploads/classified-listing/2022/03/daziy_millar1-1-400x240.jpg" class="rtcl-thumbnail" alt="daziy_millar1-1" decoding="async" title="" /> <span class='listing-type-badge'>For Rent</span></a></div><div class="item-content"> <div class="property-type"><a href="../listing-category/villa/index.php">Villa</a></div> <h3 class="listing-title rtcl-listing-title"><a href="../property/diamond-manco-apartment/index.php" title="Diamond Manco Apartment">Diamond Manco Apartment</a></h3> <ul class="listing-meta"><li class="location"><i class="rtcl-icon rtcl-icon-location" aria-hidden="true"></i><a href="../listing-location/new-jersey/index.php">New Jersey</a></li></ul> <div class="listing-price"><div class="rtcl-price price-type-fixed"><span class="rtcl-price-amount amount"><bdi><span class="rtcl-price-currencySymbol">&#36;</span>2,500</bdi></span></div></div></div>
            </div>
		    </div>
	</div></div><div id="tag_cloud-2" class="widget widget_tag_cloud"><h3 class="widget-heading">Popular Tags</h3><div class="tagcloud"><a href="../tag/blog/index.php" class="tag-cloud-link tag-link-4 tag-link-position-1" style="font-size: 8pt;" aria-label="Blog (10 items)">Blog</a>
<a href="../tag/magazine/index.php" class="tag-cloud-link tag-link-6 tag-link-position-2" style="font-size: 8pt;" aria-label="Magazine (10 items)">Magazine</a>
<a href="../tag/news/index.php" class="tag-cloud-link tag-link-3 tag-link-position-3" style="font-size: 8pt;" aria-label="News (10 items)">News</a>
<a href="../tag/newspaper/index.php" class="tag-cloud-link tag-link-5 tag-link-position-4" style="font-size: 8pt;" aria-label="Newspaper (10 items)">Newspaper</a></div>
</div><div id="media_image-9" class="widget widget_media_image"><img width="380" height="476" src="../wp-content/uploads/2021/09/sidebar-ad.jpg" class="image wp-image-16640  attachment-full size-full" alt="" style="max-width: 100%; height: auto;" decoding="async" title="" /></div>        </aside>
    </div>            </div>
        </div>
    </main>
	</div> #content -->
...
</script><!-- Mailchimp for WordPress v4.9.14 - ../index.php://wordpress.org/plugins/mailchimp-for-wp/ --><form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-7934" method="post" data-id="7934" data-name="Subscribe" ><div class="mc4wp-form-fields"><div class="rt-mailchimp-wrap">
<input type="email" name="EMAIL" placeholder="Enter e-mail addess" required class="form-control"/>
<div class="rt-animation-btn">
  <input type="submit" value="Subscribe" />
</div>
</div></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1721913717" /><input type="hidden" name="_mc4wp_form_id" value="7934" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin --></div><div id="text-2" class="footer-box widget_text">			<div class="textwidget"><p>We never span you!</p>
</div>
...
var thickboxL10n = {"next":"Next >","prev":"< Prev","image":"Image","of":"of","close":"Close","noiframes":"This feature requires inline frames. You have iframes disabled or your browser does not support them.","loadingAnimation":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-includes\/js\/thickbox\/loadingAnimation.gif"};
var _wpUtilSettings = {"ajax":{"url":"\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php"}};
var rtcl_gallery_lang = {"ajaxurl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php","edit_image":"Edit Image","delete_image":"Delete Image","view_image":"View Full Image","featured":"Main","error_common":"Error while upload image","error_image_size":"Image size is more then 3 MB.","error_image_limit":"Image limit is over.","error_image_extension":"File extension not supported."};
var rtcl_add_post = {"hide_ad_type":"","form_uri":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/post-an-ad\/","character_limit":{"title":0,"description":0},"message":{"ad_type":"Please select ad type first","parent_cat":"Please select parent category first"}};
var rtcl_map = {"plugin_url":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-content\/plugins\/classified-listing","location":"local","center":{"address":"New York United States","lat":"43.1561681","lng":"-75.8449946"},"zoom":{"default":17,"search":17},"cluster_options":{"center":{"lat":0,"lng":0},"max_zoom":18,"zoom":3,"scroll_wheel":false,"fit_bound":true}};
var rtcl = {"plugin_url":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-content\/plugins\/classified-listing","decimal_point":".","i18n_required_rating_text":"Please select a rating","i18n_decimal_error":"Please enter in decimal (.) format without thousand separators.","i18n_mon_decimal_error":"Please enter in monetary decimal (.) format without thousand separators and currency symbols.","is_rtl":"","is_admin":"","ajaxurl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php","confirm_text":"Are you sure?","re_send_confirm_text":"Are you sure you want to re-send verification link?","__rtcl_wpnonce":"affb6d8463","rtcl_listing_base":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/all-properties\/","rtcl_category":"","rtcl_category_base":"listing-category","category_text":"Category","go_back":"Go back","location_text":"Location","rtcl_location":"","rtcl_location_base":"listing-location","user_login_alert_message":"Sorry, you need to login first.","upload_limit_alert_message":"Sorry, you have only %d images pending.","delete_label":"Delete Permanently","proceed_to_payment_btn_label":"Proceed to payment","finish_submission_btn_label":"Finish submission","phone_number_placeholder":"XXX","popup_search_widget_auto_form_submission":"1","loading":"Loading ...","is_listing":"0","is_listings":"","listing_term":"","has_map":"1","online_status_seconds":"300","online_status_offline_text":"Offline Now","online_status_online_text":"Online Now"};
var rtclAjaxFilterObj = {"clear_all_filter":"Clear all filters","no_result_found":"No result found.","result_count":{"all":"Showing all % results","part":"Showing _ of % results"},"filter_scroll_offset":"50"};
var HomListiObj = {"ajaxUrl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-admin\/admin-ajax.php","appendHtml":"","themeUrl":"../index.php:\/\/www.radiustheme.com\/demo\/wordpress\/themes\/homlisti\/wp-content\/themes\/homlisti","lsSideOffset":"130","rtStickySidebar":"enable","rtMagnificPopup":"enable"};
var rtcl_single_listing_localized_params = {"slider_options":{"rtl":false,"autoHeight":true},"slider_enabled":"1","zoom_enabled":"1","photoswipe_enabled":"1","photoswipe_options":{"shareEl":false,"closeOnScroll":false,"history":false,"hideAnimationDuration":0,"showAnimationDuration":0},"zoom_options":[]};
/* ]]> */
</script>
<script>
var wpo_server_info_js = {"user_agent":"Mozilla\/4.5 (compatible; HTTrack 3.0x; Windows 98)"}
    loadAsync('../wp-content/cache/wpo-minify/1721845095/assets/wpo-minify-footer-284efa1d.min.js', null);
</script>
		<script type="text/javascript">
		window.wp = window.wp || {};
		...
		<input type="hidden" id="_ajax_linking_nonce" name="_ajax_linking_nonce" value="01f3598e38" />		<h1 id="link-modal-title">Insert/edit link</h1>
...
<!-- Mirrored from www.radiustheme.com/demo/wordpress/themes/homlisti/post-an-ad/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jul 2024 13:28:02 GMT -->
</html>
<!-- WP Optimize page cache - ../index.php://getwpo.com - Page not served from cache  -->
